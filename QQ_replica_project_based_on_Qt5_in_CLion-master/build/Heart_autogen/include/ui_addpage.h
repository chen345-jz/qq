...
public:
    ...
    QPushButton *pushButton_stranger;
...
""));
        ...
        pushButton_stranger = new QPushButton(groupBox);
        pushButton_stranger->setObjectName(QString::fromUtf8("pushButton_stranger"));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        pushButton_stranger->setFont(font);

        horizontalLayout->addWidget(pushButton_stranger);

        pushButton_friend = new QPushButton(groupBox);
        pushButton_friend->setObjectName(QString::fromUtf8("pushButton_friend"));
        pushButton_friend->setFont(font);

        horizontalLayout->addWidget(pushButton_friend);
    ...
    void retranslateUi(QWidget *AddPage)
    {
        ...
        pushButton_stranger->setText(QCoreApplication::translate("AddPage", "\351\231\214\347\224\237\344\272\272", nullptr));
        pushButton_friend->setText(QCoreApplication::translate("AddPage", "\345\245\275\345\217\213", nullptr));
