...
QT_MOC_LITERAL(1, 9, 11), // "msgReceived"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "data"
QT_MOC_LITERAL(4, 27, 11), // "QTcpSocket*"
QT_MOC_LITERAL(5, 39, 6) // "socket"

    },
    "MyServer\0msgReceived\0\0data\0QTcpSocket*\0"
    "socket"
};
...
void MyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->msgReceived((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< QTcpSocket*(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MyServer::*)(const QByteArray & , QTcpSocket * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::msgReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyServer::msgReceived(const QByteArray & _t1, QTcpSocket * _t2)
{
