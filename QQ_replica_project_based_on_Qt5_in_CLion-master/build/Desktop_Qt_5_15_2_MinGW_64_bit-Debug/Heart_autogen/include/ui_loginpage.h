...
public:
    ...
    QToolButton *toolButton_avatarSelect;
    QSpacerItem *horizontalSpacer_3;
    QWidget *widget_6;
    QVBoxLayout *verticalLayout;
    QLineEdit *lineEdit_nickname_register;
    ...
    QLabel *label;
    QLineEdit *lineEdit_openDeveloper;
...
"	border-radius:30px;\n"
"}\n"
"QToolButton#toolButton_avatarSelect:hover{	\n"
"	background-color: rgba(200, 200, 200, 125);\n"
"	border-radius:30px;\n"
"}\n"
"QToolButton#toolBut"
                        "ton_avatarSelect:press{	\n"
...
"}"));
        ...
        horizontalLayout->setContentsMargins(11, 0, 11, 11);
        ...
        toolButton_avatarSelect = new QToolButton(widget_3);
        toolButton_avatarSelect->setObjectName(QString::fromUtf8("toolButton_avatarSelect"));
        toolButton_avatarSelect->setMinimumSize(QSize(200, 200));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/ico/SelectAvatar.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_avatarSelect->setIcon(icon2);
        toolButton_avatarSelect->setIconSize(QSize(200, 200));
        toolButton_avatarSelect->setAutoExclusive(false);

        horizontalLayout_3->addWidget(toolButton_avatarSelect);
        ...
        lineEdit_nickname_register = new QLineEdit(widget_6);
        lineEdit_nickname_register->setObjectName(QString::fromUtf8("lineEdit_nickname_register"));
        lineEdit_nickname_register->setMinimumSize(QSize(0, 40));
        lineEdit_nickname_register->setAlignment(Qt::AlignCenter);

        verticalLayout->addWidget(lineEdit_nickname_register);
        ...
        lineEdit_openDeveloper = new QLineEdit(tab_4);
        lineEdit_openDeveloper->setObjectName(QString::fromUtf8("lineEdit_openDeveloper"));
        lineEdit_openDeveloper->setMinimumSize(QSize(0, 40));
        lineEdit_openDeveloper->setEchoMode(QLineEdit::Password);
        lineEdit_openDeveloper->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(lineEdit_openDeveloper, 1, 1, 1, 3);

        horizontalSpacer_16 = new QSpacerItem(133, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_16, 2, 0, 1, 2);

        pushButton_sure = new QPushButton(tab_4);
        pushButton_sure->setObjectName(QString::fromUtf8("pushButton_sure"));
        pushButton_sure->setMinimumSize(QSize(120, 60));
        pushButton_sure->setMaximumSize(QSize(120, 60));
        pushButton_sure->setStyleSheet(QString::fromUtf8("background-color: rgb(85, 170, 255);"));

        gridLayout->addWidget(pushButton_sure, 2, 2, 1, 1);

        horizontalSpacer_17 = new QSpacerItem(133, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_17, 2, 3, 1, 2);
    ...
    void retranslateUi(QWidget *LoginPage)
    {
        ...
        toolButton_avatarSelect->setText(QString());
        lineEdit_nickname_register->setText(QString());
        lineEdit_nickname_register->setPlaceholderText(QCoreApplication::translate("LoginPage", "\350\276\223\345\205\245\346\230\265\347\247\260", nullptr));
        ...
        label->setText(QCoreApplication::translate("LoginPage", "\345\274\200\345\217\221\350\200\205\347\225\214\351\235\242\345\214\205\345\220\253\357\274\232\346\225\260\346\215\256\345\272\223\347\256\241\347\220\206\357\274\214\346\237\261\345\233\276\357\274\214\351\245\274\345\233\276\347\224\237\346\210\220", nullptr));
        lineEdit_openDeveloper->setText(QString());
        lineEdit_openDeveloper->setPlaceholderText(QCoreApplication::translate("LoginPage", "\350\276\223\345\205\245\345\274\200\345\217\221\350\200\205\345\257\206\347\240\201\344\273\245\350\277\233\345\205\245\345\274\200\345\217\221\350\200\205\347\225\214\351\235\242", nullptr));
        pushButton_sure->setText(QCoreApplication::translate("LoginPage", "OK", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QCoreApplication::translate("LoginPage", "\345\274\200\345\217\221\350\200\205\351\200\211\351\241\271", nullptr));
    } // retranslateUi
