...
QT_MOC_LITERAL(4, 33, 11), // "msgReceived"
QT_MOC_LITERAL(5, 45, 4), // "data"
QT_MOC_LITERAL(6, 50, 11), // "onConnected"
QT_MOC_LITERAL(7, 62, 14), // "onDisconnected"
QT_MOC_LITERAL(8, 77, 11), // "onReadyRead"
QT_MOC_LITERAL(9, 89, 12) // "sendHeartMsg"

    },
    "MyClient\0connected\0\0disconnected\0"
    "msgReceived\0data\0onConnected\0"
    "onDisconnected\0onReadyRead\0sendHeartMsg"
};
...
void MyClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->msgReceived((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 3: _t->onConnected(); break;
        case 4: _t->onDisconnected(); break;
        case 5: _t->onReadyRead(); break;
        case 6: _t->sendHeartMsg(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClient::connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClient::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyClient::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClient::msgReceived)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void MyClient::msgReceived(QByteArray _t1)
{
